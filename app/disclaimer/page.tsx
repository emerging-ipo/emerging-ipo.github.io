...
export default function DisclaimerPage() {
  return <main className="legal-shell">
    ...
    <article className="legal-document">
      <div className="legal-title"><span>DISCLAIMER</span><h1>免責聲明</h1><p>最後更新日期：2026 年 7 月 15 日</p></div>
      ...
      <div className="legal-summary warning">本站整理臺灣證券交易所、證券櫃檯買賣中心、公開資訊觀測站及 Yahoo 股市等公開或第三方資料，內容僅供資訊查閱與一般研究參考，不構成投資建議、招攬、推介、交易指示或收益保證。</div>
      <section><h2>1. 網站定位與獨立性</h2><p>本站與臺灣證券交易所、證券櫃檯買賣中心、公開資訊觀測站、Yahoo、Google、網站內出現的公司及其他第三方均無隸屬、代理或背書關係，除非另有清楚書面揭露。第三方名稱及商標僅用於識別資料來源或外部連結，其權利歸各權利人所有。</p></section>
      ...
      <section><h2>4. 資料可能延遲或修正</h2><p>本站以自動化程序整理行情、IPO 時程與公司資訊，資料主要取自臺灣證券交易所、證券櫃檯買賣中心、公開資訊觀測站、Yahoo 股市及其他公開來源。即使採取自動更新與交叉檢查，仍可能因來源延遲、錯誤、遺漏、修正、網路中斷、欄位變動、交易暫停或程式解析差異，而不完整、不即時或與原始公告不同。重要資訊請以主管機關、交易所、櫃買中心、公開資訊觀測站及公司正式公告為準。</p></section>
      ...
      <section><h2>7. 資料、著作權與外部連結</h2><p>本站尊重資料來源、著作權及商標權，並於頁面標示主要來源。外部網站的內容、可用性、正確性、授權條款與隱私做法由其營運者負責；連結不表示本站認可或保證其內容。使用者應依原始網站的最新條款使用相關資料。</p></section>
