...
export default function PrivacyPage() {
  return <main className="legal-shell">
    ...
    <article className="legal-document">
      <div className="legal-title"><span>PRIVACY POLICY</span><h1>隱私權政策</h1><p>最後更新日期：2026 年 7 月 15 日</p></div>
      <div className="legal-summary">本政策依本站目前實際功能撰寫。本站現階段不要求註冊帳號，也不提供留言或聯絡表單。</div>

      <section><h2>1. 適用範圍</h2><p>本政策說明「興櫃市場雷達」（以下簡稱本站）在您瀏覽網站時，如何處理可能產生的使用資訊。本政策不適用於本站連結的臺灣證券交易所、證券櫃檯買賣中心、公開資訊觀測站、Yahoo 股市或其他第三方網站。</p></section>
      ...
      <section><h2>4. 第三方資料與外部連結</h2><p>本站會連結公司公開資料、Yahoo 技術線圖與公開新聞頁面。點擊外部連結後，資料處理方式由該網站的隱私權政策與服務條款規範；本站不控制第三方的 Cookie、內容或資料保存方式，連結亦不表示彼此有合作或背書關係。</p></section>
