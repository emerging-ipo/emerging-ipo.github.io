...
export const metadata: Metadata = {
  title: "隱私權政策",
  description: "興櫃雷達觀測站的資料蒐集、Cookie 與第三方服務隱私說明。",
};
...
export default function PrivacyPage() {
  return <main className="legal-shell">
    ...
    <article className="legal-document">
      ...
      <section><h2>1. 適用範圍</h2><p>本政策說明「興櫃雷達觀測站」（以下簡稱本站）在您瀏覽網站時，如何處理可能產生的使用資訊。本政策不適用於本站連結的交易所、櫃買中心、公開資訊觀測站、公司網站、行情服務或其他第三方網站。</p></section>
