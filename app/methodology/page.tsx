...
export default function MethodologyPage() {
  return <main className="legal-shell">
    ...
    <article className="legal-document">
      ...
      <section><h2>2. 上週五收盤價</h2><p>為便於週比較，本站將前一完整交易週最後一個有有效成交資料之交易日最後成交價，標示為「上週五收盤價」。一般情況為星期五；若星期五因國定假日、休市或個別標的無有效成交資料，則依序採該週最後一個有效交易日。週漲跌幅以當日最後成交價相較此基準計算；日漲跌則仍以當日加權平均成交價相較前一交易日加權均價計算。</p></section>
