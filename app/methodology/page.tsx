...
export default function MethodologyPage() {
  return <main className="legal-shell">
    ...
    <article className="legal-document">
      ...
      <section><h2>1. 報價與更新時間</h2><p>本站於平日盤後，以可取得的公開市場資料更新最後成交價與當日加權平均成交價，並顯示資料來源回傳的報價時間。興櫃市場可能因交易稀少而長時間沒有新成交；此時畫面會標示無報價或保留最後可確認資料，不將缺值視為價格不變。資料僅供資訊查閱，實際成交資訊仍以券商及市場公告為準。</p></section>
      <section><h2>2. 上週比較基準</h2><p>上週基準均價取決於官方行情日期：使用前一完整交易週最後一個有有效成交資料之交易日的加權平均成交價。一般情況為星期五；若星期五因國定假日、休市或個別標的無有效成交資料，則依序採該週最後一個有效交易日。週漲跌幅以當日加權平均成交價相對此基準計算，日漲跌則以當日加權平均成交價相較前一交易日加權均價計算。</p></section>
