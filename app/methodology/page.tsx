...
export default function MethodologyPage() {
  return <main className="legal-shell">
    ...
    <article className="legal-document">
      <div className="legal-title"><span>METHODOLOGY</span><h1>資料方法與分類說明</h1><p>最後更新：2026 年 7 月 15 日</p></div>
      <div className="legal-summary">本站以公開資料的日期、價格與事件狀態進行整理。所有排行與標籤均為規則式分類，不代表公司評價、報酬預測或操作方向。</div>

      <section><h2>1. 報價與更新時間</h2><p>現價優先採用 Yahoo 股市可取得的最新報價，並顯示來源回傳的報價時間。興櫃市場可能因交易稀少而長時間沒有新成交；此時畫面會標示無報價或保留最後可確認資料，不將缺值視為價格不變。</p></section>
      ...
      <section><h2>7. 備援與資料限制</h2><p>來源機構或報價服務暫時無法連線時，本站可能顯示最近一次成功取得的公開資料快照，並在來源恢復後更新。資料仍可能因來源延遲、修正、代號轉換或交易稀少而出現時間差，重要資訊應回到原始公告查核。</p></section>
    </article>
