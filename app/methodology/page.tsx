...
export default function MethodologyPage() {
  return <main className="legal-shell">
    ...
    <article className="legal-document">
      ...
      <section><h2>1. 報價與更新時間</h2><p>本站於平日收盤後，以可取得的公開市場資料更新成交價，並顯示資料來源回傳的報價時間。興櫃市場可能因交易稀少而長時間沒有新成交；此時畫面會標示無報價或保留最後可確認資料，不將缺值視為價格不變。資料僅供資訊查閱，實際成交資訊仍以券商及市場公告為準。</p></section>
